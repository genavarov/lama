...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Lamacoin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  litecoind [options]                     " + _("Start Lamacoin Core Daemon") + "\n";
    ...
    try
    {
        ...
        if (fDaemon)
        {
            fprintf(stdout, "Lamacoin server starting\n");
