...
4. Enter "Lamacoin" as project name, enter src/qt as location
...
Once dependencies are compiled, see release-process.md for how the Lamacoin-Qt.app
bundle is packaged and signed to create the .dmg disk image that is distributed.

Running
-------

It's now available at `./lamacoind`, provided that you are still in the `src`
...
you can monitor its process by looking at the debug.log file, like this:
    ...
    tail -f $HOME/Library/Application\ Support/Lamacoin/debug.log
